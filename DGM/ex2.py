...
parser.add_argument('--model_path', default='train_results_mult/trained_models/epoch_200.ckpt', help='Model checkpoint path')
...
gpu_to_use = 0
output_dir = os.path.join(BASE_DIR, './ex2_results')
...
def predict():
    ...
    with tf.Session(config=config) as sess:
        ...
        for shape_idx in range(len_pts_files):
            ...
            cur_label_one_hot = np.zeros((1, point_num, 3), dtype=np.float32)
