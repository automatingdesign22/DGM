...
parser.add_argument('--model_path', default='/home/lab1501/Cirp2022DGM/DGM/train_results_mult/trained_models_ex1/epoch_50.ckpt', help='Model checkpoint path')
FLAGS = parser.parse_args()
class_name = raw_input('this is the model of ex1_1,please confirm ').lower()

latent1 = np.load( "/home/lab1501/Cirp2022DGM/data/shape_net_core_uniform_samples_2048/04379246/latent1.npy" )
latent2 = np.load( "/home/lab1501/Cirp2022DGM/data/shape_net_core_uniform_samples_2048/04379246/latent2.npy" )
latent3 = np.load( "/home/lab1501/Cirp2022DGM/data/shape_net_core_uniform_samples_2048/04379246/latent3.npy")
latent = latent3+1*(latent1-latent2)
